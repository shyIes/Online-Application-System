...
$select = "SELECT first_name, last_name, applicant_id, email, phone FROM sase_student.users";
        ...
        <td class="main" colspan="2" valign="top">
            ...
            <table width="75%" align="center" id="new">
                <tr>
                    ...
                    <th align="left" id="new" class="new2">Email</th>
                    <th align="left" id="new" class="new2">Phone</th>
                    <th align="left" id="new" class="new2">Application Form</th>
                    <th align="left" id="new" class="new2">Evaluation Outcome</th>
                </tr>
                <?php
                for($i = 0;$i<$rows1;$i++)
                {
                    ...
                    <tr>
                        ...
                        <td id="new" class="new2">
                            ...
                            $select = "SELECT recommendation, evaluator FROM evaluation WHERE applicant_id='$appid[$i]'";
                            $result = mysql_query($select) or die('Database error '.mysql_error());
                            ...
                            while($row = mysql_fetch_assoc($result))
                            {
                                $reco = $reco . $row['recommendation']." (" . $row['evaluator'] . "), ";
                            }
