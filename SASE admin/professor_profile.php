...
$select = "SELECT first_name,last_name,email FROM professors where email='$username'";
...
$update = "UPDATE professors SET first_name ='$firstname',last_name='$lastname'
...
<div align="center">
    ...
    <table width="865" border="0" cellpadding="0">
        ...
        <td class="main" colspan="2" valign="top">
            ...
            <p align="center"> <a href="professor_selection.php">Back to Selection Page</a> </p>
            <div align="center">
                <br><br><br>
                <?php
                if($flag==1) echo "<h4 align=center style=color:green;> Details saved</h4>";
                ?>
                <form name="profile" action="professor_profile.php" method="post" class="AdvancedForm">
                    <table align="center" cellpadding="3" cellspacing="2">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="professor_changepassword.php">Change Password</a>
                            </td>
                        </tr>
