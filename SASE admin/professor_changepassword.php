...
if(isset($_POST['currentpass'])) {
    ...
    $find_pass = "SELECT salt, password, email FROM professors WHERE email='$find_user'";
    ...
    if ($check_hash == $stored_hash)
    {
        ...
        $update = "UPDATE professors SET salt ='$user_salt', password ='$hashedpass' WHERE email='$username'";
    ...
    <table width="865" border="0" cellpadding="0">
        ...
        <td class="main" colspan="2" valign="top">
            ...
            <div align="center">
                ...
                ?>
                <form name="changepassword" action="professor_changepassword.php" method="post" class="AdvancedForm">
