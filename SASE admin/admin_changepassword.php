...
if(isset($_POST['currentpass'])) {
    ...
    $find_pass = "SELECT salt, password, email FROM admin WHERE email='$find_user'";
    ...
    if ($check_hash == $stored_hash)
    {
        ...
        $update = "UPDATE admin SET salt ='$user_salt', password ='$hashedpass' WHERE email='$username'";
    ...
    <script type="text/javascript">
        ...
        jQuery(function(){
            ...
            jQuery("#newpass").validate({
                expression: "if (VAL.match(/^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*?[!@#$%^&*+_-])([a-zA-Z0-9!@#$%^&*+_-]{8,15})$/) && VAL) return true; else return false;",
    ...
    <table width="865" border="0" cellpadding="0">
        ...
        <td class="main" colspan="2" valign="top">
            ...
            <div align="center">
                ...
                ?>
                <form name="admin_changepassword" action="admin_changepassword.php" method="post" class="AdvancedForm">
